...
group4=temp.groupby("location",as_index=False).agg({"hospital_beds_per_thousand":"mean","life_expectancy":"mean"})
group4.sort_values(by="hospital_beds_per_thousand",inplace=True,ascending=False)
group4=group4[:15]
fig4 = px.scatter(group4, x='hospital_beds_per_thousand', y='life_expectancy',color="location")
...
group5=temp.groupby("location",as_index=False).agg({"diabetes_prevalence":"mean","life_expectancy":"mean"})
group5.sort_values(by="diabetes_prevalence",inplace=True,ascending=False)
group5=group5[:15]
fig5 = px.scatter(group5, x='diabetes_prevalence', y='life_expectancy',color="location")
